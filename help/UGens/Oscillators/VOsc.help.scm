...
;;; Variable wavetable oscillator.  A wavetable lookup oscillator
;;; which can be swept smoothly across wavetables. All the wavetables
;;; must be allocated to the same size. Fractional values of table
;;; will interpolate between two adjacent tables.
...
;;; Note about wavetables: VOsc requires the b_gen sine1 wavetable
;;; flag to be ON.
