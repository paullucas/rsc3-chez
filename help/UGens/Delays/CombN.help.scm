...
;;; interpolation, CombC uses all pass interpolation.  All times are
;;; in seconds.  The decay time is the time for the echoes to decay by
;;; 60 decibels. If this time is negative then the feedback
;;; coefficient will be negative, thus emphasizing only odd harmonics
;;; at an octave lower.
