...
;;; level. Limiter will not overshoot like Compander will, but it
;;; needs to look ahead in the audio. Thus there is a delay equal to
;;; twice the lookAheadTime.  Limiter, unlike Compander, is completely
