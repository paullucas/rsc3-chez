...
(let* ((cf (list 35.45676040649414
       ...
       (k (dyn-klank s (midi-ratio fs) fo ds (klank-data cf ca (map recip cd)))))
  (audition (out 0 (pan2 k p 1))))
