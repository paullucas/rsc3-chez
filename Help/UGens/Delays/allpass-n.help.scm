...
(add z (allpass-n z 0.01 (xline kr 0.0001 0.01 20 do-nothing) 0.2))

(add z (allpass-l z 0.01 (xline kr 0.0001 0.01 20 do-nothing) 0.2))

(add z (allpass-c z 0.01 (xline kr 0.0001 0.01 20 do-nothing) 0.2))
...
(allpass-n (mul (decay (dust ar 1) 0.2) z) 0.2 0.2 3)
