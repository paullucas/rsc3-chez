...
(mul (fbsine-c ar (fdiv sample-rate 4) 1 0.1 1.1 0.5 0.1 0.1) 0.2)

;; increase feedback

(let ((fb (line kr 0.01 4 10 do-nothing)))
  (mul (fbsine-c ar sample-rate 1 fb 1.1 0.5 0.1 0.1) 0.2))

;; increase phase multiplier

(let ((a (line kr 1 2 10 do-nothing)))
  (mul (fbsine-c ar sample-rate 1 0 a 0.5 0.1 0.1) 0.2))
