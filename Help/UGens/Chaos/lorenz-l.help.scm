...
(mul (lorenz-l ar (mouse-x kr 20 sample-rate 0 0.1)
	         10 28 2.667 0.05 0.1 0 0)
     0.3)

;; randomly modulate params

(mul (lorenz-l ar sample-rate
	         (mul-add (lfnoise0 kr 1) 2 10)
		 (mul-add (lfnoise0 kr 1) 20 38)
		 (mul-add (lfnoise0 kr 1) 1.5 2)
		 0.05
		 0.1 0.0 0.0)
     0.2)
...
(mul
 (sin-osc ar (mul-add
	     (lag
	      (lorenz-l ar (mouse-x kr 1 200 0 0.1) 10 28 2.667 0.05 0.1 0 0)
	      0.003)
	     800 900)
	 0)
 0.4)
