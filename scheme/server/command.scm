...
(define (/n_setn id index n . values) (append (list "/n_setn" id index n) values))
...
(define (/s_new name id action target . initialize) (append (list "/s_new" name id action target) initialize))
...
(define (/b_setn id index n . values) (append (list "/b_setn" id index n) values))
...
(define (/b_gen id cmd . values) (list "/done" (append (list "/b_gen" id cmd) values)))
(define (/c_set id value) (list "/c_set" id value))
(define (/c_setn id n . values) (append (list "/c_setn" id n) values))
