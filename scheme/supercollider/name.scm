...
(defineH unary-operator-names '(Neg Not IsNil NotNil BitNot Abs
...
(defineH unary-operator-name special
  (ref unary-operator-names special))

(defineH binary-operator-names '(Add Sub Mul IDiv FDiv Mod EQ NE LT GT
...
(defineH binary-operator-name special
  (ref binary-operator-names special))

(defineH ugen-name/operator name special
  (cond
