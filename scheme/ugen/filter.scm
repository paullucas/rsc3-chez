...
(define-filter Amplitude (in attackTime releaseTime) 1)
...
(define-filter Pause () 1)
(define-filter PauseSelf () 1)
(define-filter PauseSelfWhenDone () 1)
...
(define-filter QuadC (freq a b c xi) 1)
(define-filter QuadL (freq a b c xi) 1)
(define-filter QuadN (freq a b c xi) 1)
...
(define-filter SampleDur () 1)
(define-filter SampleRate () 1)
