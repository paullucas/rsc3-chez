...
(define-specialized* Drand (length data) 1 dr)
(define-specialized* Dseq (length data) 1 dr)
(define-specialized* Dser (length data) 1 dr)
(define-specialized* Dseries (length data) 1 dr)
(define-specialized* Dswitch1 (length data) 1 dr)
(define-specialized* Dwhite (length lo hi) 1 dr)
(define-specialized* Dxrand (length data) 1 dr)
