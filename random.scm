...
(define choose/proportions
  (lambda (proportions l)
...
(define randi
  (lambda (a b) (floor-exact (rand a b))))

;; Complex variant.

(define randc
  (lambda (a b d e) (make-rectangular (rand a b) (rand d e))))
